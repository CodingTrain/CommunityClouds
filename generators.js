...
function noCloud() {
    ...
    p2 = {
        "x": (width / 4) + randomOffset(100),
        "y": 240 + randomOffset(50)
    };
    p3 = {
        "x": width * 2 / 4 + randomOffset(100),
        "y": 150 + randomOffset(50)
    };
    p4 = {
        "x": 150 + (width * 3 / 4) + randomOffset(100),
        "y": 270 + randomOffset(50)
    };
    p5 = {
        "x": width - 200,
        "y": height - 300
    ...
    bg = 150;
    fill(bg);
    drawCloud([p1, p2, p3, p4, p5].map(function(e) {
        return {
            "x": e.x + 100,
            "y": e.y
        }
